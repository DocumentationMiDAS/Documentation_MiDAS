...
-   Du côté des **données de Pôle emploi**, MiDAS comprend l'ensemble des demandeurs d'emploi (DE) inscrits à Pôle emploi au moins un jour depuis 2017, dont les indemnisés à l'Assurance-chômage (AC) ;
...
-   Du côté des **données de la Dares,** MiDAS contient, parmi les MMO, tous les contrats salariés en cours ou terminés après le 1er janvier 2017 pour les individus du champ. Le champ de MiDAS (graphique 1) comprend ainsi les demandeurs d'emploi inscrits à Pôle emploi (fichier FHS) dont les indemnisés (fichier FNA), auxquels sont appariés les bénéficiaires des minima sociaux . Les données MMO sont appariées à ce champ.

![Graphique 1 : Schéma du champ MiDAS](../images/champ_appariement.png)

...
**Demandeurs d'emploi** **indemnisables au moins 1 jour depuis le 1er janvier 2017**. Pour ces individus, MiDAS contient **tout l'historique de leur indemnisation** depuis 1993, ainsi que leurs périodes d'affiliation et d'activité réduite.
...
L'activité réduite : l'information sur les allocataires de l'Assurance-chômage qui travaillent (c'est-à-dire inscrits en catégories B et C à France Travail) est renseignée dans le FHS (table E0) et dans le FNA (table PAR). Deux différences sont à noter entre ces deux tables :

-   Seule la table PAR renseigne sur le salaire brut perçu dans le cadre d'une activité réduite exercée par le demandeur d'emploi (variable KQBARP) ;

-   La table E0 ne contient que les heures d'activité réduite des personnes inscrites en catégories A, B ou C.

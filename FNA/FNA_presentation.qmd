...
-   Le segment **« [Employeur](EMP/EMP_presentation.html) » (EMP, LN4B)** renseigne sur l'employeur (identifié via le Siret) de l'allocataire lors de son contrat fait générateur ;
...
L'activité réduite : l'information sur les personnes inscrites et/ou allocataires de l'assurance-chômage qui travaillent est renseignée dans le FHS (table E0) et dans le FNA (table PAR). Cette [fiche](../../../Fiches/Activité%20réduite.html) détaille comment repérer les personnes en activité réduite.

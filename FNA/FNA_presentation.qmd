...
L'activité réduite : l'information sur les personnes inscrites et/ou allocataires de l'assurance-chômage qui travaillent est renseignée dans le FHS (table E0) et dans le FNA (table PAR). Cette [fiche](../../../Fiches/Activité_réduite.qmd) détaille comment repérer les personnes en activité réduite.

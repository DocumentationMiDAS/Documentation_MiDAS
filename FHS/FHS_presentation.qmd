...
Toute personne inscrite à France Travail au moins un jour depuis le 1er janvier 2017 avec son historique d'inscription remontant sur les 10 années qui précèdent la date d'exraction du fichier pour la France entière.
...
-   La **table [Cat9_10](Cat9_10/Cat_presentation.html)** permet de repérer les personnes inscrites en catégories F et G ;

-   La **table [Rad_actuh](Rad_actuh/Rad_presentation.html)** permet d'identifier les personnes radiées en raison d'un défaut d'actualisation hybride ;

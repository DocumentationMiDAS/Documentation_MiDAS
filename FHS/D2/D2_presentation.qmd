...
La table D2 donne les informations sur l'indemnisabilité des demandeurs d'emploi aux allocations chômage. Le fait d'être indemnisable à une allocation chômage ne veut pas dire être indemnisé : un demandeur d'emploi peut être indemnisé sur une période, mais ne pas percevoir d'allocation, par exemple lorsque les revenus tirés de son activité réduite dépassent le plafond. La table D2 ne permet pas de distinguer entre les personnes indemnisables et les personnes indemnisées.

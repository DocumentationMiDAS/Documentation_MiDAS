...
La Dares fournit les données de Mouvements de Main-d'œuvre (MMO) tirées de l'exploitation des déclarations sociales nominatives (DSN).
...
[Exemple]{.underline} : un contrat actif sur les années 2017 et 2018 (date de début ≤ 31/12/2017 et 01/01/2018 ≤ date de fin ≤ 31/12/2018) sera présent dans toutes les tables mais uniquement identifiable via son identifiant L_CONTRAT_SQN dans les tables 2017 et 2018.
